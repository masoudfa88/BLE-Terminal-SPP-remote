...
class SerialSocket extends BluetoothGattCallback {
    ...
    private static final UUID BLUETOOTH_LE_MICROCHIP_SERVICE    = UUID.fromString("0000ABF0-0000-1000-8000-00805F9B34FB");
    private static final UUID BLUETOOTH_LE_MICROCHIP_CHAR_RW    = UUID.fromString("0000ABF2-0000-1000-8000-00805F9B34FB");
    private static final UUID BLUETOOTH_LE_MICROCHIP_CHAR_W     = UUID.fromString("0000ABF1-0000-1000-8000-00805F9B34FB");
...
//    private static final UUID BLUETOOTH_LE_TIO_SERVICE          = UUID.fromString("0000ABF0-0000-1000-8000-00805F9B34FB");
    private static final UUID BLUETOOTH_LE_TIO_SERVICE          = UUID.fromString("0000FEFB-0000-1000-8000-00805F9B34FB");
//    private static final UUID BLUETOOTH_LE_TIO_CHAR_TX          = UUID.fromString("0000ABF3-0000-1000-8000-00805F9B34FB"); // WNR
    private static final UUID BLUETOOTH_LE_TIO_CHAR_TX          = UUID.fromString("00000001-0000-1000-8000-008025000000"); // WNR
//    private static final UUID BLUETOOTH_LE_TIO_CHAR_RX          = UUID.fromString("0000ABF4-0000-1000-8000-00805F9B34FB"); // N
    private static final UUID BLUETOOTH_LE_TIO_CHAR_RX          = UUID.fromString("00000002-0000-1000-8000-008025000000"); // N
    private static final UUID BLUETOOTH_LE_TIO_CHAR_TX_CREDITS  = UUID.fromString("0000ABF1-0000-1000-8000-00805F9B34FB"); // W
    private static final UUID BLUETOOTH_LE_TIO_CHAR_RX_CREDITS  = UUID.fromString("0000ABF2-0000-1000-8000-00805F9B34FB"); // I
